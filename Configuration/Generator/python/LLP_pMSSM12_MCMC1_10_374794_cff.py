...
SLHAFileForPythia8  = cms.string('SigPoints/pMSSM12_MCMC1_10_374794.slha'), 
...
#        SLHAParameters = cms.vstring('SLHAFILE = SigPoints/LMG34.slha'),
    ...
    massPoint = cms.untracked.int32(1101),
#    particleFile = cms.untracked.string('Customise/data/geant4_pMSSM_lmg.slha')
    particleFile = cms.untracked.string('Customise/data/geant4_pMSSM12_MCMC1_10_374794.slha') 
