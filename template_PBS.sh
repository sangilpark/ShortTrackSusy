#!/bin/bash
#PBS -e /u/user/sangilpark/WorkDir/DisappearingTracks/jobs/logs
#PBS -o /u/user/sangilpark/WorkDir/DisappearingTracks/jobs/logs

# cms software setup
export JOBDIR=/u/user/sangilpark/WorkDir/DisappearingTracks/jobs/SIGID_n0
export OUTPUTDIR=/u/user/sangilpark/WorkDir/DisappearingTracks/jobs/outputs

export CMSSW_BASE=/u/user/sangilpark/WorkDir/DisappearingTracks/CMSSW_7_1_25_patch1
cd $CMSSW_BASE/src
...
export CMSSW_BASE=/u/user/sangilpark/WorkDir/DisappearingTracks/CMSSW_8_0_21
cd $CMSSW_BASE/src
eval `scramv1 runtime -sh`
cd $JOBDIR
...
cp SIGID_step2_AODSIM_n0.root $OUTPUTDIR
...
cp SIGID_step3_miniAODSIM_n0.root $OUTPUTDIR
